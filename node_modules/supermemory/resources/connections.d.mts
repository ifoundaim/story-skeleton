...
export declare class Connections extends APIResource {
     ...
     * ```
     */
    deleteByProvider(provider: 'notion' | 'google-drive' | 'onedrive', body?: ConnectionDeleteByProviderParams | null | undefined, options?: RequestOptions): APIPromise<ConnectionDeleteByProviderResponse>;
    /**
...
export declare namespace ConnectionDeleteByProviderResponse {
    interface DeletedConnection {
        id: string;
        provider: string;
    }
}
